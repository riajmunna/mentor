                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="d-flex justify-content-center py-4">
                            <a href="index.html" class="logo d-flex align-items-center w-auto">
                                <img src="{{asset('adminAsset')}}/assets/img/logo.png" alt="">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('register')}}" method="post" class="row g-3 needs-validation" novalidate>
                                    @csrf
                                    <div class="col-12">
                                        <label for="yourName" class="form-label">Enter Name</label>
                                    ...
                                    <div class="col-12">
                                        <label for="yourEmail" class="form-label">Enter Email</label>
                                        <input type="email" name="email" class="form-control"
                                               placeholder="Please enter a valid Email address!" id="yourEmail"
                                               required>
                                    ...
                                    <div class="col-12">
                                        <label for="yourPassword" class="form-label">Enter Password Again</label>
                                        <input type="password" name="password_confirmation" class="form-control"
                                               id="yourPassword" placeholder="Please enter your password again!"
                                               required>
                                        <div class="invalid-feedback">Please enter your password!</div>
                                    </div>
