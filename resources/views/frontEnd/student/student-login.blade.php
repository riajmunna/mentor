                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6">
                            <div class="card-body p-4 p-sm-5">
                                ...
                                <form class="form-body" action="{{route('student.login')}}" method="post">
                                    @csrf
                                    <div class="d-grid">
                                        <a class="btn btn-white radius-30" href="javascript:;"><span
                                                class="d-flex justify-content-center align-items-center"><img
                                                    class="me-2" src="{{asset('admin')}}/assets/images/icons/search.svg"
                                                    width="16" alt="">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <label for="inputEmailAddress" class="form-label text-danger">{{Session::get('message')}}</label>
                                            <div class="ms-auto position-relative">
                                                <div
                                                    class="position-absolute top-50 translate-middle-y search-icon px-3">
                                                    <i class="bi bi-envelope-fill"></i></div>
                                                <input type="text" class="form-control radius-30 ps-5"
                                                       id="inputEmailAddress" placeholder="Email Address/Phone Number"  name="username">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <p class="mb-0">Don't have an account yet? <a
                                                    href="{{route('student.register')}}">Sign up here</a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
